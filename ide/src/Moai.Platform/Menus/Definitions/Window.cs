...
namespace Moai.Platform.Menus.Definitions.Window
{
    ...
    class Split : Action
    {
        ...
        {
            this.Implemented = false;
            this.ItemIcon = IDE.Resources.Images.windows_split;
            this.Text = "Split";
            this.Enabled = false;
        }
    }
    ...
    class SetAutoHide : Action
    {
        ...
        {
            this.Implemented = false;
            this.ItemIcon = IDE.Resources.Images.windows_autohide;
            this.Text = "Auto Hide";
            this.Enabled = false;
        }
    }
    ...
    class NewHorizontalTabGroup : Action
    {
        ...
        {
            this.Implemented = false;
            this.ItemIcon = IDE.Resources.Images.windows_tile_horizontal;
    ...
    class NewVerticalTabGroup : Action
    {
        ...
        {
            this.Implemented = false;
            this.ItemIcon = IDE.Resources.Images.windows_tile_vertical;
