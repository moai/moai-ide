...
namespace Moai.Platform.Windows.Designers.Code
{
    public partial class Designer : Moai.Designers.Designer, ICodeDesigner
    {
        ...
        {
            Central.Manager.CacheManager.Context.Object = this;
        }
        ...
        void c_CodeEditor_MarginClick(object sender, ScintillaNet.MarginClickEventArgs e)
        {
            ...
            if (Central.Manager.DebugManager.Running)
                return;

            // Check to see whether we should add or remove a breakpoint from this line.
            if (Central.Manager.DebugManager.Breakpoints.Count(result => result.SourceFile == relname && result.SourceLine == e.Line.Number + 1) == 0)
            {
                // Add breakpoint.
                Central.Manager.DebugManager.Breakpoints.Add(new Breakpoint(relname, (uint)e.Line.Number + 1));
            ...
            {
                // Remove breakpoint.
                Central.Manager.DebugManager.Breakpoints.RemoveAll(result => result.SourceFile == relname && result.SourceLine == e.Line.Number + 1);
                e.Line.DeleteAllMarkers();
            }
        }
        ...
        /// <summary>
        /// Boolean value indicating whether this designer can currently have data deleted.
        /// </summary>
        bool IDeletable.CanDelete
        {
            get { return this.c_CodeEditor.Selection.Length > 0; }
        }
