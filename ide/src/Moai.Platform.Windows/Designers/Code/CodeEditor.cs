...
namespace Moai.Platform.Windows.Designers.Code
{
    public class CodeEditor : ScintillaNet.Scintilla
    {
        ...
        private ICacheManager m_Manager = null;

        public event EventHandler SyntaxCheckRequested;

        public CodeEditor(ICacheManager manager, bool highlight)
            : base()
        {
            ...
            // Configure markers.
            this.Markers[0].SetImage(IDE.Resources.Images.breakpoint);
            this.Markers[1].SetImage(IDE.Resources.Images.current_line);
        ...
        private void CodeEditor_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            {
                // Show global list.
                this.AutoComplete.List = Central.Manager.CacheManager.AutoComplete.GetList(null);
        ...
        void CodeEditor_CharAdded(object sender, ScintillaNet.CharAddedEventArgs e)
        {
            ...
            if (lc == '.')
            {
                ...
                this.AutoComplete.List = Central.Manager.CacheManager.AutoComplete.GetList(s);
                //this.AutoComplete.Show();
            }
            else if (lc == '=')
            {
