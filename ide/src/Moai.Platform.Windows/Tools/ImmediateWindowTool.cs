...
namespace Moai.Platform.Windows.Tools
{
    public partial class ImmediateWindowTool : Tool
    {
        public ImmediateWindowTool()
        {
            ...
            Central.Manager.DebugManager.DebugStart += new EventHandler(DebugManager_DebugStart);
            Central.Manager.DebugManager.DebugContinue += new EventHandler(DebugManager_DebugContinue);
            Central.Manager.DebugManager.DebugPause += new EventHandler(DebugManager_DebugPause);
            Central.Manager.DebugManager.DebugStop += new EventHandler(DebugManager_DebugStop);
        }
        ...
        /// </summary>
        public override Moai.Platform.UI.ToolPosition DefaultState
        {
            get
            {
                return Moai.Platform.UI.ToolPosition.DockBottom;
            }
        }
        ...
        private void c_ImmediateTextBox_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Enter)
            {
                ...
                if (!Central.Manager.DebugManager.Paused || !Central.Manager.DebugManager.Running)
                ...
                else
                {
                    ...
                    Central.Manager.DebugManager.Evaluate(value, (result) =>
                    {
