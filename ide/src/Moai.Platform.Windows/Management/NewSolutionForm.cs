...
namespace Moai.Platform.Windows.Management
{
    ...
    public partial class NewSolutionForm : Form
    {
        ...
        public NewSolutionForm()
        {
            ...
            if (!Directory.Exists(Central.Manager.Settings["DefaultProjectArea"]))
            {
                Directory.CreateDirectory(Central.Manager.Settings["DefaultProjectArea"]);
            }

            // Set the solution location text box to the default location area.
            this.c_SolutionLocationTextBox.Text = Central.Manager.Settings["DefaultProjectArea"];
        ...
        private void c_BrowseSolutionLocationButton_Click(object sender, EventArgs e)
        {
            ...
            fbd.SelectedPath = Central.Manager.Settings["DefaultProjectArea"];
